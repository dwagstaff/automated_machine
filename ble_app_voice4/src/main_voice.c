...
#define DEVICE_NAME                          "Nordic_HRM4"                              /**< Name of device. Will be included in the advertising data. */
...
void ias_evt_handler(ble_ias_t *p_ias, ble_ias_evt_t *p_evt)
{
...
static void services_init(void)
{
    ...
    // IAS
    {
    	static ble_ias_init_t p_ias_init;
    	memset(&p_ias_init, 0, sizeof(p_ias_init));
    	p_ias_init.evt_handler= ias_evt_handler;
    	err_code= ble_ias_init(&p_ias, &p_ias_init);
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_ias_on_ble_evt(&p_ias, p_ble_evt);
