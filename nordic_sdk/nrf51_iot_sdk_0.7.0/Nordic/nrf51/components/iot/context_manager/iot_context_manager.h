 ...
 */
 ...
 /** @file
 *
 * @defgroup iot_context_manager Context Manager for Nordic's IPv6 stack and 6LoWPAN module
 * @{
 * @ingroup iot_sdk_common
 * @brief Context identifiers and prefixes related to the identifiers.
 *
