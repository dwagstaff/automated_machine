 ...
 *                              be placed.
 * @param[inout] p_length       Size of the encoded value. 
...
// Do we need to encode/decode opaque?
// uint32_t coap_opt_opaque_encode(uint8_t * p_encoded, uint8_t * p_string)
// uint32_t coap_opt_opaque_decode(coap_option_t * p_option, uint8_t * p_encoded) 
