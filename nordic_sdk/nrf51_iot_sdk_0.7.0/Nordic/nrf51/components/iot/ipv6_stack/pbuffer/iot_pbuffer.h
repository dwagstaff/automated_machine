 ...
 */
 ...
 /** @file
 *
 * @defgroup iot_pbuffer Packet buffer management for Nordic's IPv6 stack
 * @{
 * @ingroup iot_sdk_common
 * @brief Memory allocation for IPv6 stack layers
 *
 * @details This module interfaces with the Memory Manager to allocate memory
