...
/** @defgroup HPS_UUID_TEST Definitions for the HTTP Proxy Service used for test purposes only. These are not SIG assigned.
 * @{ */
#define BLE_UUID_HPS_SERVICE                                    0xAAB0      /** HTTP Proxy Service(HPS) UUID */
#define BLE_UUID_HPS_URI_CHAR                                   0xAABA      /** HPS URI Characteristic UUID */
#define BLE_UUID_HPS_HEADERS_CHAR                               0xAABB      /** HPS Headers Characteristic UUID */
#define BLE_UUID_HPS_ENTITY_BODY_CHAR                           0xAABC      /** HPS Entity Body Characteristic UUID */
#define BLE_UUID_HPS_STATUS_CHAR                                0xAABD      /** HPS Status Characteristic UUID */
#define BLE_UUID_HPS_CTRLPT_CHAR                                0xAABE      /** HPS Control Point Characteristic UUID */
#define BLE_UUID_HPS_HTTPS_CHAR                                 0xAABF      /** HPS HTTPS Security Characteristic UUID */
/** @} */
